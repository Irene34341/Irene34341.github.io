...
(function () {
    ...
    function load() {
        ...
        if (inArray(includes, 'mapbox-gl-enhance')) {
            inputCSS("../../web/libs/mapbox-gl-js-enhance/1.12.1/mapbox-gl-enhance.css");
            inputScript("../../web/libs/mapbox-gl-js-enhance/1.12.1/mapbox-gl-enhance.js");
        }
        if (inArray(includes, 'draw')) {
            inputCSS("../../web/libs/mapbox-gl-js/plugins/mapbox-gl-draw/1.4.1/mapbox-gl-draw.min.css");
            inputScript("../../web/libs/mapbox-gl-js/plugins/mapbox-gl-draw/1.4.1/mapbox-gl-draw.min.js");
        }
        ...
        if (inArray(includes, 'three')) {
            inputScript("../../web/libs/three/0.150.1/three.min.js");
        }
        ...
        if (inArray(includes, 'proj4')) {
            inputScript('../../web/libs/proj4/2.9.0/proj4.min.js');
        }
        if (inArray(includes, 'echarts-gl')) {
            inputScript("../../web/libs/echarts-gl/1.1.2-fix/echarts-gl.min.js");
        }
