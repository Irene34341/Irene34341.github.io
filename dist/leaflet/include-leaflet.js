...
(function () {
    ...
    function load() {
        ...
        if (inArray(includes, 'd3')) {
            inputScript('libs/d3/7.8.2/d3.min.js');
        }
        if (inArray(includes, 'd3-hexbin')) {
            inputScript("libs/d3-hexbin/0.2.2/d3-hexbin.v0.2.min.js");
        }
        if (inArray(includes, 'd3Layer')) {
            inputScript("libs/leaflet/plugins/leaflet.d3Layer/leaflet-d3Layer.min.js");
        }
        if (inArray(includes, 'elasticsearch')) {
            inputScript('libs/elasticsearch/16.7.3/elasticsearch.min.js');
        }
        if (inArray(includes, 'deck')) {
            inputScript("libs/deck.gl/5.1.3/deck.gl.min.js");
        }
        if (inArray(includes, 'xlsx')) {
            inputScript('libs/xlsx/0.18.5/xlsx.core.min.js');
        }
        ...
        if (inArray(includes, 'iclient-plot-leaflet')) {
            inputCSS("libs/plotting/leaflet/11.1.0/iclient-plot-leaflet.css");
            if (supportES6()) {
                inputScript("libs/plotting/leaflet/11.1.0/iclient-plot-leaflet-es6.min.js");
            } else {
                inputScript("libs/plotting/leaflet/11.1.0/iclient-plot-leaflet.min.js");
            }
        }
        ...
        if (inArray(includes, 'leaflet.markercluster')) {
            inputCSS("libs/leaflet/plugins/leaflet.markercluster/1.5.3/MarkerCluster.Default.css");
            inputCSS("libs/leaflet/plugins/leaflet.markercluster/1.5.3/MarkerCluster.css");
            inputScript("libs/leaflet/plugins/leaflet.markercluster/1.5.3/leaflet.markercluster.js");
        }
